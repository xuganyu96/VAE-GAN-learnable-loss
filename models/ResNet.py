...
class ResNet(gluon.Block):
    ...
    def forward(self, x):
        ...
        #
        # The output of this method has shape (batch_size, n_classes)
        # In the case of the 1 class, I do still wish that
        # the output shape be (batch_size,)
        # So I will do the reshaping outside in the training script
